...
public class StopwordsRemover {
	...
	private static final StopwordsRemover instance = new StopwordsRemover();
	...
	public int size() {
		return stopwordsVocabalary.size();
	}
	
	/** The hash set containing the list of stopwords */
	protected HashSet<String> stopwordsVocabalary = null;

	/** The default stopwords object (stoplist based on Rainbow) */
	protected static StopwordsRemover m_Stopwords;

	static {
		if (m_Stopwords == null) {
			m_Stopwords = new StopwordsRemover();
		}
	}
	...
	private StopwordsRemover() {
		stopwordsVocabalary = new HashSet<String>();
		addDefaultStopWords();
	}
	...
	public void add(String word) {
		if (word.trim().length() > 0)
			stopwordsVocabalary.add(word.trim().toLowerCase());
	}
	...
	public boolean remove(String word) {
		return stopwordsVocabalary.remove(word);
	}
	...
	public boolean is(String word) {
		return stopwordsVocabalary.contains(word.toLowerCase().trim());
	}

	public void init() {
		this.clear();
		this.addDefaultStopWords();
	}
